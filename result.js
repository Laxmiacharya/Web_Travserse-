...
if (Math.abs(sumAngles - expectedSum) > 75 * Math.sqrt(stations)) {
    ...
    for (let i = 1; i < stations; i++) {
        resultTable += `<tr>
                            ...
                            <td style="color: black;">${angles[i - 1].toFixed(4)}</td> <!-- Observed angle from station 2 -->
                            <td>${correctedAngles[i - 1].toFixed(4)}</td> <!-- Corrected angle -->
                            <td>${bearings[i].toFixed(4)}</td> <!-- Bearings -->
                            <td style="color: black;">${distances[i - 1].toFixed(4)}</td> <!-- Distance -->
    ...
    resultTable += `<tr>
                        ...
                        <td style="color: black;">${angles[stations - 1]?.toFixed(2)}</td>  <!-- Angle between Station 6 and 1 -->
                        ...
                        <td style="color: black;">${distances[stations - 1].toFixed(4)}</td>  <!-- Final distance -->
                        ...
                        <td style="color: red;">${coordinates[stations].easting.toFixed(4)}</td>  <!-- Final Easting -->
                        <td style="color: red;">${coordinates[stations].northing.toFixed(4)}</td>  <!-- Final Northing -->
                    </tr>`;
